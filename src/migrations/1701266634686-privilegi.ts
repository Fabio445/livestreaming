...
export class Privilegi1701266634686 implements MigrationInterface {
    name = 'Privilegi1701266634686'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`privilegi\` (\`idPrivilegi\` int NOT NULL AUTO_INCREMENT, \`tipo\` varchar(255) NOT NULL, PRIMARY KEY (\`idPrivilegi\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
     //   await queryRunner.query(`ALTER TABLE \`Follow\` DROP FOREIGN KEY \`FK_a7bdb15a3c272eb48eb1157d0ee\``);
       // await queryRunner.query(`ALTER TABLE \`Follow\` DROP FOREIGN KEY \`FK_3c2e0afb9d2f358984a44a7761d\``);
        ...
        await queryRunner.query(`DROP TABLE \`privilegi\``);
    }
