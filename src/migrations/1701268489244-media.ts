...
export class Media1701268489244 implements MigrationInterface {
    name = 'Media1701268489244'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`media\` (\`idMedia\` int NOT NULL AUTO_INCREMENT, \`titolo\` varchar(255) NOT NULL, \`durata\` varchar(255) NOT NULL, \`url\` varchar(255) NOT NULL, \`tipo\` tinyint NOT NULL, \`idCanale\` int NULL, \`idCategoria\` int NULL, PRIMARY KEY (\`idMedia\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idUser\` \`idUser\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idPrivilegi\` \`idPrivilegi\` int NULL`);
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idCanale\` \`idCanale\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`media\` ADD CONSTRAINT \`FK_ee539ea200348457ce6693ac0f8\` FOREIGN KEY (\`idCanale\`) REFERENCES \`canale\`(\`idCanale\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`media\` ADD CONSTRAINT \`FK_774ccff901bf3fb3755e0de8803\` FOREIGN KEY (\`idCategoria\`) REFERENCES \`categoria\`(\`idCategoria\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`live\` DROP FOREIGN KEY \`FK_61f5a7a02ede174b496f3e31e84\``);
        await queryRunner.query(`ALTER TABLE \`live\` DROP FOREIGN KEY \`FK_a156b922058edbcac86be588bca\``);
        await queryRunner.query(`ALTER TABLE \`media\` DROP FOREIGN KEY \`FK_774ccff901bf3fb3755e0de8803\``);
        await queryRunner.query(`ALTER TABLE \`media\` DROP FOREIGN KEY \`FK_ee539ea200348457ce6693ac0f8\``);
        await queryRunner.query(`ALTER TABLE \`portafoglio\` DROP FOREIGN KEY \`FK_7b880cd5b0873890de36917ade4\``);
        await queryRunner.query(`ALTER TABLE \`transazione\` DROP FOREIGN KEY \`FK_d6319b413e1bfd59c5e62bf8f6d\``);
        await queryRunner.query(`ALTER TABLE \`transazione\` DROP FOREIGN KEY \`FK_9333f9d3f1ac89bfcf316846e77\``);
        ...
        await queryRunner.query(`ALTER TABLE \`canale\` ADD CONSTRAINT \`FK_44c53755d04131af0798c620980\` FOREIGN KEY (\`idUser\`) REFERENCES \`user\`(\`idUser\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`canale\` ADD CONSTRAINT \`FK_dd7d05cf549aef180ccd1106774\` FOREIGN KEY (\`idSocial\`) REFERENCES \`social\`(\`idSocial\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idCanale\` \`idCanale\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idPrivilegi\` \`idPrivilegi\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`subscription\` CHANGE \`idUser\` \`idUser\` int NULL DEFAULT 'NULL'`);
