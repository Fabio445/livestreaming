...
export class Watch1701269266993 implements MigrationInterface {
    name = 'Watch1701269266993'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`watch\` (\`idWatch\` int NOT NULL AUTO_INCREMENT, \`idUser\` int NULL, \`idLive\` int NULL, \`idGuest\` int NULL, PRIMARY KEY (\`idWatch\`)) ENGINE=InnoDB`);
       ...
       // await queryRunner.query(`ALTER TABLE \`media\` CHANGE \`idCanale\` \`idCanale\` int NULL`);
       // await queryRunner.query(`ALTER TABLE \`media\` CHANGE \`idCategoria\` \`idCategoria\` int NULL`);
       ...
       // await queryRunner.query(`ALTER TABLE \`media\` ADD CONSTRAINT \`FK_774ccff901bf3fb3755e0de8803\` FOREIGN KEY (\`idCategoria\`) REFERENCES \`categoria\`(\`idCategoria\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`watch\` ADD CONSTRAINT \`FK_d82383e56e8a912157a2e87cafe\` FOREIGN KEY (\`idUser\`) REFERENCES \`user\`(\`idUser\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`watch\` ADD CONSTRAINT \`FK_51e3fc96e48d91f41c96ae97c7a\` FOREIGN KEY (\`idLive\`) REFERENCES \`live\`(\`idLive\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`watch\` ADD CONSTRAINT \`FK_f3c27ea01a477f395e0bbedd168\` FOREIGN KEY (\`idGuest\`) REFERENCES \`guest\`(\`idGuest\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
       ...
       // await queryRunner.query(`ALTER TABLE \`LiveTag\` DROP FOREIGN KEY \`FK_a0142635cf78ac594cd3f13a2a8\``);
        ...
        await queryRunner.query(`ALTER TABLE \`live\` DROP FOREIGN KEY \`FK_61f5a7a02ede174b496f3e31e84\``);
        await queryRunner.query(`ALTER TABLE \`live\` DROP FOREIGN KEY \`FK_a156b922058edbcac86be588bca\``);
        await queryRunner.query(`ALTER TABLE \`watch\` DROP FOREIGN KEY \`FK_f3c27ea01a477f395e0bbedd168\``);
        await queryRunner.query(`ALTER TABLE \`watch\` DROP FOREIGN KEY \`FK_51e3fc96e48d91f41c96ae97c7a\``);
        await queryRunner.query(`ALTER TABLE \`watch\` DROP FOREIGN KEY \`FK_d82383e56e8a912157a2e87cafe\``);
       ...
       // await queryRunner.query(`ALTER TABLE \`media\` DROP FOREIGN KEY \`FK_ee539ea200348457ce6693ac0f8\``);
        ...
        await queryRunner.query(`ALTER TABLE \`live\` ADD CONSTRAINT \`FK_61f5a7a02ede174b496f3e31e84\` FOREIGN KEY (\`idCanale\`) REFERENCES \`canale\`(\`idCanale\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`live\` ADD CONSTRAINT \`FK_a156b922058edbcac86be588bca\` FOREIGN KEY (\`idCategoria\`) REFERENCES \`categoria\`(\`idCategoria\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
       // await queryRunner.query(`ALTER TABLE \`media\` CHANGE \`idCategoria\` \`idCategoria\` int NULL DEFAULT 'NULL'`);
      //  await queryRunner.query(`ALTER TABLE \`media\` CHANGE \`idCanale\` \`idCanale\` int NULL DEFAULT 'NULL'`);
