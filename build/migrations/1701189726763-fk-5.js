...
exports.Fk51701189726763 = void 0;
var Fk51701189726763 = /** @class */ (function () {
    function Fk51701189726763() {
        this.name = 'Fk51701189726763';
    }
    Fk51701189726763.prototype.up = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE `user` ADD `dataNascita` date NOT NULL")];
                    case 1:
                        _a.sent();
                    ...
                    case 9:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `portafoglio` DROP FOREIGN KEY `FK_7b880cd5b0873890de36917ade4`")];
                    case 10:
                        _a.sent();
                    ...
                    case 16:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `portafoglio` ADD CONSTRAINT `FK_7b880cd5b0873890de36917ade4` FOREIGN KEY (`idUser`) REFERENCES `user`(`idUser`) ON DELETE NO ACTION ON UPDATE NO ACTION")];
                    case 17:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Fk51701189726763.prototype.down = function (queryRunner) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, queryRunner.query("ALTER TABLE `portafoglio` DROP FOREIGN KEY `FK_7b880cd5b0873890de36917ade4`")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, queryRunner.query("ALTER TABLE `viewer` DROP FOREIGN KEY `FK_22d3ec057bb8794fa4a8069393d`")];
                    case 2:
    ...
    return Fk51701189726763;
}());
exports.Fk51701189726763 = Fk51701189726763;
//# sourceMappingURL=1701189726763-fk-5.js.map