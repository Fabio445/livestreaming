...
export class Tag1701186287861 implements MigrationInterface {
    name = 'Tag1701186287861'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX \`IDX_0f84e305f7c8266987daa69cd3\` ON \`portafoglio\``);
        await queryRunner.query(`CREATE TABLE \`tag\` (\`idTag\` int NOT NULL AUTO_INCREMENT, \`nome\` varchar(255) NOT NULL, PRIMARY KEY (\`idTag\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX \`IDX_0f84e305f7c8266987daa69cd3\` ON \`portafoglio\` (\`idSocial\`)`);
    }

}*/
//# sourceMappingURL=1701186287861-tag.js.map