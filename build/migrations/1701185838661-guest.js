...
export class Guest1701185838661 implements MigrationInterface {
    name = 'Guest1701185838661'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`guest\` (\`idGuest\` int NOT NULL AUTO_INCREMENT, PRIMARY KEY (\`idGuest\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`portafoglio\` ADD UNIQUE INDEX \`IDX_0f84e305f7c8266987daa69cd3\` (\`idSocial\`)`);
        await queryRunner.query(`ALTER TABLE \`user\` CHANGE \`deleteAt\` \`deleteAt\` timestamp NULL`);
        await queryRunner.query(`CREATE UNIQUE INDEX \`REL_0f84e305f7c8266987daa69cd3\` ON \`portafoglio\` (\`idSocial\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`portafoglio\` DROP INDEX \`IDX_0f84e305f7c8266987daa69cd3\``);
...
*/ 
//# sourceMappingURL=1701185838661-guest.js.map