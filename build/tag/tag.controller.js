...
var TagController = /** @class */ (function () {
    ...
    TagController.prototype.create = function (createTagDto) {
        return this.tagService.create(createTagDto);
    };
    TagController.prototype.findAll = function () {
        return this.tagService.findAll();
    };
    TagController.prototype.findOne = function (id) {
        return this.tagService.findOne(+id);
    };
    TagController.prototype.update = function (id, updateTagDto) {
        return this.tagService.update(+id, updateTagDto);
    };
    TagController.prototype.remove = function (id) {
